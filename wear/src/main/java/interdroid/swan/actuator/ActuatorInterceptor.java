...
public class ActuatorInterceptor extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
       ...
       /* else if(intent.hasExtra(WearConstants.BROADCAST_ACTUATE)){
            Log.d(TAG, "Broadcast Receiver: Actuate called");
            actuate(context, intent.getExtras().getString(DataMapKeys.EXPRESSION_ID), null);
        } */
    }
     ...
     */
    public static void actuate(Context context, String expressionId, TimestampedValue[] newValues) {
