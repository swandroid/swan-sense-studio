...
public class BLELogRecord {
    ...
    public BLELogRecord(long startTime, long startTimeApp, long reqDuration, long connTime, long discoveryTime, boolean failed) {
    ...
    public static String printHeader() {
        return "Time\tReq_Duration\tConn_Duration\tDiscovery_Duration\tSetup_Duration\tStatus";
    }
    ...
    public String toString() {
        return (startTime - startTimeApp) + "\t" + reqDuration
                ...
                + "\t" + (discoveryTime - startTime) + "\t" + (failed ? "fail" : "success");
    }
}
