    ...
    public static class ConfigActivity extends AbstractActuatorActivity {
        ...
        protected String[] getParameterDefaultValues() {
            return new String[] {
                    ...
                    "id",
                    "topic",
                    String.valueOf(MqttConnectOptions.CLEAN_SESSION_DEFAULT),
                    "false",
                    String.valueOf(MqttConnectOptions.CONNECTION_TIMEOUT_DEFAULT),
                    String.valueOf(MqttConnectOptions.KEEP_ALIVE_INTERVAL_DEFAULT),
                    String.valueOf(MqttConnectOptions.MAX_INFLIGHT_DEFAULT),
                    String.valueOf(MqttConnectOptions.MQTT_VERSION_DEFAULT),
                    "",
                    ""
            };
        }
